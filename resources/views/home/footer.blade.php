  ...
  <div class="bk-wrap">
    <div class="bk-footer-grid">
      ...
      <div class="bk-footer-about">
        <a href="/"><img src="logo02.png" alt="Alchemists Aureum Bank" class="bk-footer-logo"></a>
        <p>Alchemists Aureum Bank is dedicated to innovating, simplifying, and humanizing digital banking for customers around the world.</p>
      ...
      <div class="bk-footer-col">
        ...
        <div class="bk-footer-contact-item">
          ...
          <div><small>Email</small><p><a href="mailto:support@alchemistsaureumbnk.com">support@alchemistsaureumbnk.com</a></p></div>
        </div>
      </div>
    </div>
  </div>
  <div class="bk-footer-bottom">
    <div class="bk-wrap">
      <div class="bk-footer-bottom-inner">
        <p>&copy; {{ date('Y') }} Alchemists Aureum Bank. All rights reserved.</p>
