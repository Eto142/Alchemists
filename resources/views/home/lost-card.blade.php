...
<section class="bk-page-section">
  <div class="bk-wrap" style="max-width:820px">
    <div class="bk-content-block sr">
      ...
      <p style="line-height:1.8;color:#475569;text-align:center;max-width:600px;margin:0 auto 28px">If your Alchemists Aureum Bank card has been lost or stolen, notify us immediately. We will freeze your card, monitor for unauthorised activity, and issue a replacement.</p>
      ...
      <div class="bk-page-grid-2" style="margin-top:28px">
        ...
        <div class="bk-info-card sr" style="text-align:center">
          ...
          <h4>Email Us</h4>
          <p><a href="mailto:{{ $basic->email ?? 'support@alchemistsaureumbnk.com' }}" style="color:var(--bk-blue);font-weight:600">{{ $basic->email ?? 'support@alchemistsaureumbnk.com' }}</a></p>
