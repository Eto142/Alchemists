  ...
  <div class="bk-wrap">
    ...
    <div class="bk-page-grid-3">
      <div class="bk-testi-mini sr">
        ...
        <p>"Switching to Alchemists Aureum Bank was the best financial decision I've made. The savings rates are excellent and the app is incredibly easy to use."</p>
