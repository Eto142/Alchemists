...
<title>Transaction Failed - Alchemists Aureum Bank</title>
</head>
<body style="margin:0;padding:0;background-color:#f0f2f0;font-family:Arial,Helvetica,sans-serif">
<div style="display:none;max-height:0;overflow:hidden;mso-hide:all">Your transaction could not be completed.&nbsp;&zwnj;&nbsp;&zwnj;&nbsp;&zwnj;&nbsp;&zwnj;&nbsp;&zwnj;</div>
...
<h1 style="margin:0;font-size:22px;font-weight:700;color:#111827;font-family:Arial,sans-serif">Transaction Failed</h1>
</td></tr>
<tr><td align="center" style="padding-bottom:24px">
<p style="margin:0;font-size:14px;color:#6b7280;font-family:Arial,sans-serif">Payment Update</p>
</td></tr>
</table>
...
<p style="margin:0 0 6px;font-size:13px;font-weight:700;color:#991b1b;font-family:Arial,sans-serif;text-transform:uppercase;letter-spacing:0.5px">&#10007; Transaction Failed</p>
<p style="margin:0;font-size:15px;color:#374151;font-family:Arial,sans-serif;line-height:1.7">{{ $data }}</p>
</td></tr></table>
<p style="margin:0 0 14px;font-size:14px;color:#374151;font-family:Arial,sans-serif;line-height:1.6">We were unable to process your transaction. This may be due to insufficient funds, a declined instruction, or a security hold. Please log in to your dashboard or contact support for further assistance.</p>
