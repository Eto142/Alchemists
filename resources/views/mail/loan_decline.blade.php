...
<title>Loan Application Declined - Alchemists Aureum Bank</title>
</head>
<body style="margin:0;padding:0;background-color:#f0f2f0;font-family:Arial,Helvetica,sans-serif">
<div style="display:none;max-height:0;overflow:hidden;mso-hide:all">An update regarding your loan application from Alchemists Aureum Bank.&nbsp;&zwnj;&nbsp;&zwnj;&nbsp;&zwnj;&nbsp;&zwnj;&nbsp;&zwnj;</div>
...
<div style="display:inline-block;width:56px;height:56px;background-color:#7f1d1d;border-radius:50%;text-align:center;font-size:26px;line-height:56px">&#128196;</div>
</td></tr>
<tr><td align="center" style="padding-bottom:6px">
<h1 style="margin:0;font-size:22px;font-weight:700;color:#111827;font-family:Arial,sans-serif">Loan Application Declined</h1>
</td></tr>
<tr><td align="center" style="padding-bottom:24px">
<p style="margin:0;font-size:14px;color:#6b7280;font-family:Arial,sans-serif">Loan Application Update</p>
</td></tr>
</table>
<table width="100%" cellpadding="0" cellspacing="0" border="0" style="background-color:#fef2f2;border:1px solid #fecaca;border-radius:10px;margin-bottom:20px">
<tr><td style="padding:20px 22px">
<p style="margin:0 0 6px;font-size:13px;font-weight:700;color:#991b1b;font-family:Arial,sans-serif;text-transform:uppercase;letter-spacing:0.5px">&#10007; Declined</p>
<p style="margin:0;font-size:15px;color:#374151;font-family:Arial,sans-serif;line-height:1.7">{{ $data }}</p>
</td></tr></table>
<p style="margin:0 0 14px;font-size:14px;color:#374151;font-family:Arial,sans-serif;line-height:1.6">We regret to inform you that your loan application was not approved at this time. For more information or to discuss alternative options, please contact our support team.</p>
