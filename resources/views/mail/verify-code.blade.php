...
<title>Confirm Your Account - Alchemists Aureum Bank</title>
</head>
<body style="margin:0;padding:0;background-color:#f0f2f0;font-family:Arial,Helvetica,sans-serif">
<div style="display:none;max-height:0;overflow:hidden;mso-hide:all">Your Alchemists Aureum Bank activation code is inside.&nbsp;&zwnj;&nbsp;&zwnj;&nbsp;&zwnj;&nbsp;&zwnj;&nbsp;&zwnj;</div>
...
<h1 style="margin:0;font-size:22px;font-weight:700;color:#111827;font-family:Arial,sans-serif">Confirm Your Account</h1>
</td></tr>
<tr><td align="center" style="padding-bottom:24px">
<p style="margin:0;font-size:14px;color:#6b7280;font-family:Arial,sans-serif">Account Verification</p>
</td></tr>
</table>
<p style="margin:0 0 14px;font-size:15px;color:#374151;font-family:Arial,sans-serif;line-height:1.6">Thank you for registering with <strong>Alchemists Aureum Bank</strong>. Use the activation code below to verify your account.</p>
...
<li>If you did not request this, please disregard this email.</li>
