...
<title>Transaction Successful - Alchemists Aureum Bank</title>
</head>
<body style="margin:0;padding:0;background-color:#f0f2f0;font-family:Arial,Helvetica,sans-serif">
<div style="display:none;max-height:0;overflow:hidden;mso-hide:all">Your transaction was processed successfully.&nbsp;&zwnj;&nbsp;&zwnj;&nbsp;&zwnj;&nbsp;&zwnj;&nbsp;&zwnj;</div>
...
<h1 style="margin:0;font-size:22px;font-weight:700;color:#111827;font-family:Arial,sans-serif">Transaction Successful</h1>
</td></tr>
<tr><td align="center" style="padding-bottom:24px">
<p style="margin:0;font-size:14px;color:#6b7280;font-family:Arial,sans-serif">Payment Confirmation</p>
</td></tr>
</table>
...
<p style="margin:0 0 6px;font-size:13px;font-weight:700;color:#166534;font-family:Arial,sans-serif;text-transform:uppercase;letter-spacing:0.5px">&#10003; Transaction Successful</p>
<p style="margin:0;font-size:15px;color:#374151;font-family:Arial,sans-serif;line-height:1.7">{{ $data }}</p>
</td></tr></table>
<p style="margin:0 0 14px;font-size:14px;color:#374151;font-family:Arial,sans-serif;line-height:1.6">Your transaction has been processed successfully. Please log in to your dashboard to view the full details. If you did not authorise this transaction, contact our support team immediately.</p>
